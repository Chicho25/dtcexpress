...
<body>
  <div class="container">
    <div class="row" id="contenido">
      <table width="800">
        <tr>
          ...
          <td align="left"width="300">
            <b>
            <?php echo 'Ave. de la Amistad, Albrook'; ?>
            <br>
            <?php echo 'Ciudad de Panama'; ?>
            <br>
            <?php echo 'silvana@dtcexpress.net'; ?>
            <br>
            <?php echo 'Tel: +507-60620511'; ?>
            <br>
            <?php echo 'RUT 8-758-1606  D.V.81'; ?>
            </b>
          </td>
          <td width="300" align="right" valign="top">
            <span style="border-bottom: 1px solid #000000; "><?php echo date("Y-m-d"); ?></span>
            <b><br>Client:</b> <?php echo $arrCust["name"]; ?>
            <b><br>Fecha:</b> <?php echo $arrQuote["date"]; ?>
          </td>
        </tr>
      </table>
      <br>
      <br>
      <div class="row">
        <div class="col-md-12" id="img-out" align="left">
          <h5 style="font-weight:bold; color:purple;"></h5>
          <span style="font-size:11px;">Recibo de:______________________________________________________________________________________________________________________</span>
        </div>
      </div>
      <table width="100%">
        <tr>
