  ...
  $detail_pay = GetRecord("pay_datail_invoice", "id_invoice =".$_REQUEST['id']);
    ...
    <div class="invoice-header">
      <div class="row">
        <div class="col-xs-8">
          ...
          <h4 class="text-muted">NO: ZF19-00<?php echo number_invoice(1, $_REQUEST['id']);  ?> | Fecha: <?php echo date("Y-m-d"); ?></h4>
        </div>
        <div class="col-xs-4">
          <div class="media">
      ...
      <div class="panel panel-default">
        ...
        <table class="table table-bordered table-condensed">
          ...
          <tbody>
            <tr>
              <td>
                <?php echo $arrCust["membernumber"]; ?>
                <br>
                <small class="text-muted"></small>
              </td>
              <td class="text-right">
                <?php echo metodo_pago($detail_pay['id_method']); ?>
                <span class="mono"></span>
                <br>
                <small class="text-muted"></small>
              </td>
              <td class="text-right">
                <?php echo $detail_pay["date_time"]; ?>
                <span class="mono"></span>
                <br>
                <small class="text-muted"></small>
              </td>
